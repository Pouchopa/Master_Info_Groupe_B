...
@section('content')
    ...
    <div class="col-sm-offset-4 col-sm-4">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-heading">Modification de l'activité</div>

            <div class="panel-body"> 

                 <div class="col-sm-12">

                    {{ Form::model($patientActivite, array('url' => array('patientActivite/update', $patientActivite->id), 'method' => 'put', 'class' => 'form-horizontal panel')) }}
                        ...
                        <div class="form-group {{ $errors->has('activite_id') ? 'has-error' : '' }}">
                            ...
                            {{ Form::select('activite_id', $activites_options , Input::old('activite_id')) }}
