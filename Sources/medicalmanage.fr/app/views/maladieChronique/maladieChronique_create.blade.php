        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body"> 
                 ...
                 <div class="col-sm-12">
                    ...
                    {{ Form::open(['url' => 'maladieChronique/create', 'method' => 'post', 'class' => 'form-horizontal panel']) }} 

                        <div class="form-group {{ $errors->has('libelle') ? 'has-error' : '' }}">

                            {{ Form::label('libelle', 'Libellé* :') }}

                            {{ Form::text('libelle', null, array('class' => 'form-control', 'placeholder' => 'Entrez le libellé de la maladie')) }}
